...
const updateShipmentDetails = () => {
    ...
    const fetchShipmentDetail = async () => {
        try {
            ...
            setFormData({
                ...
                isFragile: response?.data?.shipment?.isFragile,
                value: response?.data?.shipment?.value,
                description: response?.data?.shipment?.description,
                shippedDate: formatDateForInput(response?.data?.shipment?.shippedDate),
                estimatedDeliveryDate: formatDateForInput(response?.data?.shipment?.estimatedDeliveryDate),
                origin: response?.data?.shipment?.origin,
                destination: response?.data?.shipment?.destination,
            })
    ...
    const handleUpdate = async (e) => {
        ...
        const URL = `${import.meta.env.VITE_BACKEND_URL}/shipment/update-shipment/${sid}`;
